...
export default function Tooltip({ content, children, position = 'top' }: TooltipProps) {
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          className={`absolute z-50 px-2 py-1 text-xs font-medium text-text-primary bg-bg-card border border-border rounded shadow-lg whitespace-nowrap ${positionClasses[position]}`}
        >
          {content}
          <div
