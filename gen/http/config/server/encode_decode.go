...
// endpoint.
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*config.NotificationConfig, error) {
	return func(r *http.Request) (*config.NotificationConfig, error) {
		var (
...
func DecodeUpdateDinov3Request(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*config.DINOv3Config, error) {
	return func(r *http.Request) (*config.DINOv3Config, error) {
		var (
...
func DecodeUpdateYoloRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*config.YOLOConfig, error) {
	return func(r *http.Request) (*config.YOLOConfig, error) {
		var (
...
func DecodeUpdateDetectionRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*config.DetectionConfig, error) {
	return func(r *http.Request) (*config.DetectionConfig, error) {
		var (
...
func DecodeUpdatePipelineRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*config.PipelineConfig, error) {
	return func(r *http.Request) (*config.PipelineConfig, error) {
		var (
...
func DecodeUpdateRecognitionRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*config.RecognitionConfig, error) {
	return func(r *http.Request) (*config.RecognitionConfig, error) {
		var (
